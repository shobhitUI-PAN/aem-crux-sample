            ...
            $.ajax({
                ...
                if(	data.statusmessage !== undefined ){
					...
					if(JSON.stringify(jsonwvobj.ORIGINS) !== JSON.stringify({})){
						allWebVital = allWebVital +'<div class="reference-sites"><h2 class="heading-block">Reference sites</h2><div class="accordion_aem_crux v2"> ';
